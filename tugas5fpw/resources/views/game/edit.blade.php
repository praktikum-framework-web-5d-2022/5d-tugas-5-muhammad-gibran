        ...
        <div class="col-md-12">
            ...
            <form action="{{route('game.update', ['game' => $game->id])}}" method="POST">
                ...
                <div class="mb-4">
                    ...
                    <input type="text" name="nama" id="nama" placeholder="Masukkan Nama" class="form-control" value="{{old('nama')?? $game->nama}}">
                    @error('nama')
                ...
                <div class="mb-4">
                    ...
                    <input type="text" name="dev" id="dev" placeholder="Masukkan Nama Developer" class="form-control" value="{{old('dev')?? $game->dev}}">
                    @error('dev')
                    <div class="text-danger">{{$message}}</div>
                    @enderror
                </div>
                ...
                <div class="mb-4">
                    ...
                    <input type="text" name="publisher" id="publisher" placeholder="Masukkan Nama Publisher" class="form-control" value="{{old('publisher')?? $game->datagame->publisher}}">
                    @error('publisher')
                    <div class="text-danger">{{$message}}</div>
                    @enderror
                </div>
                ...
                <div class="mb-4">
                    ...
                    <input type="text" name="rating" id="rating" placeholder="Masukkan Rating dari game" class="form-control" value="{{old('rating')?? $game->datagame->rating}}">
                    @error('rating')
                    <div class="text-danger">{{$message}}</div>
                    @enderror
                </div>
